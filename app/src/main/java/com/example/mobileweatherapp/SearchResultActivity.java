...
public class SearchResultActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (query != null) {
            ...
            city = queryParts[0];
            state = queryParts.length > 1 ? queryParts[1] : "Unknown";
        }
...
//            getSupportActionBar().setHomeAsUpIndicator(R.drawable.ic_back_arrow); // 自定义返回图标
        }
        ...
        weatherCard.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // 跳转到新的 Activity
                Intent intent = new Intent(SearchResultActivity.this, WeatherDetailActivity.class);
